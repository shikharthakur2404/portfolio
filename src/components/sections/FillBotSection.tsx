  ...
  return (
    <section id="fillbot" className="mb-28 scroll-mt-24">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8">
        <div>
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white tracking-tight mb-4 flex items-center gap-3">
            FillBot ⚡
          </h2>
        ...
        <div className="flex flex-wrap items-center gap-2 font-mono text-xs">
          <span className="px-3 py-1 rounded-full bg-sky-50 dark:bg-sky-950/60 border border-sky-200 dark:border-sky-500/30 text-sky-700 dark:text-sky-300 flex items-center gap-1.5 shadow-sm dark:shadow-none">
        ...
        <div className="lg:col-span-7 p-6 sm:p-8 rounded-3xl bg-white dark:bg-gradient-to-b dark:from-slate-900/90 dark:to-slate-950/90 border border-slate-200 dark:border-slate-800 flex flex-col justify-between shadow-sm dark:shadow-none">
          <div>
            <div className="flex items-center gap-4 mb-6">
              <img
                src="/assets/fillbot/icon.png"
                alt="FillBot Icon"
                className="w-14 h-14 rounded-2xl shadow-xl shadow-sky-500/10 border border-slate-200 dark:border-slate-800"
              />
              <div>
                <div className="font-mono text-xs text-sky-600 dark:text-sky-400 mb-1">
                  AUTONOMOUS FORM HUD // v1.0.0
                </div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white">Smart In-Browser Copilot</h3>
            ...
            <div className="rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-xl mb-6 relative group bg-slate-950">
              <img
                src="/assets/fillbot/fillbot-preview.png"
                alt="FillBot in action auto-filling job application"
                className="w-full h-auto object-cover"
              />
              <div className="absolute bottom-3 left-3 px-2.5 py-1 rounded-lg bg-slate-950/90 border border-slate-700/80 text-[11px] font-mono text-sky-300 flex items-center gap-1.5 shadow-lg">
          ...
          <div className="pt-4 border-t border-slate-200 dark:border-slate-800">
            <div className="flex flex-wrap items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="py-2.5 px-4 rounded-xl bg-slate-900 hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700 text-center font-mono text-xs font-semibold text-white transition-colors flex items-center justify-center gap-2 border border-slate-700 shadow-md"
              >
        ...
        <div className="lg:col-span-5 flex flex-col justify-between gap-6">
          <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 h-full flex flex-col justify-between shadow-sm dark:shadow-none">
            <div>
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Defeating ATS Fatigue</h3>
