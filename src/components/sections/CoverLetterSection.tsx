  ...
  return (
    <section id="cover-letter-printer" className="mb-28 scroll-mt-24">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8">
        <div>
          <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white tracking-tight mb-4">
            Cover Letter Printer 9000 🖨️
          </h2>
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl text-base">
            An end-to-end, zero-hallucination agentic pipeline engineered with <strong className="text-slate-800 dark:text-slate-200">n8n</strong>, <strong className="text-slate-800 dark:text-slate-200">JavaScript</strong>, and the <strong className="text-slate-800 dark:text-slate-200">Google Gemini 3.6 Flash API</strong>. Ingests raw Job Description dumps, extracts 15+ structured metadata keys, programmatically bridges verified engineering credentials, and outputs DIN 5008 print-ready vector PDFs via headless browser execution.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch mb-8">
        ...
        <div className="lg:col-span-8 p-6 sm:p-8 rounded-3xl bg-white dark:bg-gradient-to-b dark:from-slate-900/90 dark:to-slate-950/90 border border-slate-200 dark:border-slate-800 flex flex-col justify-between shadow-sm dark:shadow-none">
          <div>
            {/* View Switcher Tabs */}
            <div className="flex items-center justify-between gap-4 mb-6 pb-4 border-b border-slate-100 dark:border-slate-800/80">
            ...
            {activeTab === 'pipeline' ? (
              <div>
                <div className="rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-[#f9fafb] dark:bg-slate-950/80 p-2 sm:p-3 mb-4 shadow-xl">
                  <img
                    src="/assets/cover-letter-printer/pipeline-execution.png"
              ...
              <div>
                <div className="rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-[#f9fafb] dark:bg-slate-950/80 p-3 sm:p-4 mb-4 shadow-xl flex justify-center">
                  <img
                    src="/assets/cover-letter-printer/form_trigger.png"
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 dark:border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full sm:w-auto px-4 py-2 rounded-xl bg-slate-900 dark:bg-slate-800 hover:bg-slate-800 dark:hover:bg-slate-700 text-white font-mono text-xs font-semibold transition-all border border-slate-700 flex items-center justify-center gap-2"
            >
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          ...
          <div className="p-6 rounded-3xl bg-white dark:bg-gradient-to-b dark:from-slate-900/90 dark:to-slate-950/90 border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-none">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
              Direct implementation of my academic findings in the <em className="text-slate-700 dark:text-slate-300">Productivity Paradox</em> paper. Instead of allowing probabilistic LLMs to invent claims, the system constrains Gemini to a hardcoded <strong className="text-slate-700 dark:text-slate-300">Candidate Arsenal JSON</strong> containing strictly verified project telemetry (e.g. FytlY 99k LOC, Innow8, TaskOrbit).
            </p>
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 font-mono text-[11px] text-slate-600 dark:text-slate-400 space-y-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="p-4 rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800">
          ...
          <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">Webhook Form Trigger</h4>
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800">
          ...
          <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">Gemini Schema Parser</h4>
          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800">
          ...
          <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">Arsenal Bridge Logic</h4>
          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <div className="p-4 rounded-2xl bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800">
          ...
          <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">Headless PDF &amp; Sync</h4>
          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
